    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Dean Beniqno A");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Dean Beniqno A");
                mPerson.setEmail("1819117613.siswa@smkn4bdg.sch.id");
                mPerson.setAge(16);
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "089648110768";
